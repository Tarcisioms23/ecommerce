...
import com.tarcisio.moreira.domain.PagamentoComCartao;
import com.tarcisio.moreira.domain.Pedido;
import com.tarcisio.moreira.domain.Produto;
import com.tarcisio.moreira.domain.enums.EstadoPagamento;
...
import com.tarcisio.moreira.repositories.ItemPedidoRepository;
import com.tarcisio.moreira.repositories.PagamentoRepository;
...
public class DBService {
	...
	public void instantiateTestDatabase() throws ParseException {
		...
		Cliente cli1 = new Cliente(null, "Maria Silva", "tmoreirs314@gmail.com", "36378912377", TipoCliente.PESSOAFISICA, pe.encode("123"));
		cli1.getTelefones().addAll(Arrays.asList("27363323", "93838392"));
		
		Cliente cli2 = new Cliente(null, "Ana Costa", "tarcisioms23@hotmail.com", "10032595611", TipoCliente.PESSOAFISICA, pe.encode("123"));
		cli2.addPerfil(Perfil.ADMIN);
		cli1.getTelefones().addAll(Arrays.asList("32326914", "91266853"));
	    ...
	    Pedido ped1	= new Pedido(null, sdf.parse("30/09/2013 10:32"), cli1, e1);
